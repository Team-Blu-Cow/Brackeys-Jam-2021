...
public class PlayerController : MonoBehaviour
{
    ...
    public float runDeacceleration = 10.0f;       // Deceleration that occurs when running on the ground
    public float airAcceleration = 2.0f;          // Air accel
    public float airDecceleration = 2.0f;         // Deceleration experienced when opposite strafing
    ...
    private void Update()
    {
        ...
        rotY += _controls._aimVec.x * yMouseSensitivity * 0.02f;
   ...
   \*******************************************************************************************************/
    ...
    private void SetMovementDir()
    {
        ...
        _cmd.rightMove = _controls._moveVec.x;
    }
    ...
    private void QueueJump()
    {
        if (holdJumpToBhop)
        {
            wishJump = _controls._jumpButton._performed;
            return;
        }
...
public class PlayerInputs
{
    ...
    public PlayerInputs(MonoBehaviour gameObject)
    {
...
public struct ButtonInput
{
    ...
    [HideInInspector] public MonoBehaviour _gameObject;
